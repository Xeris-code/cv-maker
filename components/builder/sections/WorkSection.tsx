...
import { TranslationKeys, WorkExperience } from "@/lib/types"
            ...
            {work.map((work: WorkExperience, index: number) => (
                <div className="flex flex-col w-full gap-2 p-2 border" key={`formWorkField_${index}`}>
                        <div className="flex justify-between">
                            <Label label={`${index + 1}. ${t["positionWork"].name}`}/>
                            <button
                        ...
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={work.position} onChange={(e) => dispatch({type: "UPDATE_WORK", id: work.id, field: "position", value: e.target.value})} placeholder={t["positionWork"].placeholder}/>
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={work.company} onChange={(e) => dispatch({type: "UPDATE_WORK", id: work.id, field: "company", value: e.target.value})} placeholder={t["companyWork"].placeholder}/>
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={work.city} onChange={(e) => dispatch({type: "UPDATE_WORK", id: work.id, field: "city", value: e.target.value})} placeholder={t["cityWork"].placeholder}/>
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={work.state} onChange={(e) => dispatch({type: "UPDATE_WORK", id: work.id, field: "state", value: e.target.value})} placeholder={t["stateWork"].placeholder}/>
