        ...
        <div className="flex flex-col gap-3">
            {courses.map((course: CoursesCertificates, index: number) => (
                <div className="flex flex-col w-full gap-2 p-2 border" key={`formCourseField_${index}`}>
                        ...
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={course.name} onChange={(e) => dispatch({type: "UPDATE_COURSE", id: course.id, field: "name", value: e.target.value})} placeholder={t.fields.courses.title.placeholder}/>
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={course.org} onChange={(e) => dispatch({type: "UPDATE_COURSE", id: course.id, field: "org", value: e.target.value})} placeholder={t.fields.courses.organization.name}/>
                        <input className="border-1 border-[#E2E8F0] p-2 pl-3 focus:border-[#3B82F6] focus:outline-none border-[#475569] text-[#475569] placeholder-[#94A3B8]" value={course.url} onChange={(e) => dispatch({type: "UPDATE_COURSE", id: course.id, field: "url", value: e.target.value})} placeholder={t.fields.courses.link.name}/>
                        ...
                        <TextArea label="" placeholder={t.fields.courses.describe.placeholder} onChange={(e) => { extendTextAreaDispatch(e, course.id,  "description", dispatch)}}/>
                    </div>
            ))}
            <Button label={t.actions.addCourse} onClick={() => dispatch({type: "ADD_COURSE"})}/>
        </div>
    </>
}