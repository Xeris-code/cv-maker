...
export function getDayOptions(t: TranslationSchema){
    return Array.from({length: 32}, (_, i) => 
        i === 0
            ? { num: 0, label: t.ui.sections.personal.fields.birth.day }
...
export function getMonthOptions(t: TranslationSchema){
    ...
    const month_list = t.ui.date.months

    return Array.from({length: 13}, (_, i) => 
        i === 0 
            ? {num: 0, label: String(0), name: t.ui.sections.personal.fields.birth.month}
...
export function getYearOptions(t: TranslationSchema){
    ...
    return Array.from({length: 102}, (_, i) => 
        i === 0
            ? {num: 0, label: t.ui.sections.personal.fields.birth.year}
            : i === 1 
